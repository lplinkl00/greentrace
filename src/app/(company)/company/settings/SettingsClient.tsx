...
export default function SettingsClient({ canSave }: { canSave: boolean }) {
        ...
        try {
            ...
            if (!res.ok) {
                const msg = res.status === 403
                    ? "You don't have permission to save integration settings."
    ...
    return (
        <div className="space-y-6 max-w-4xl">
            <div>
                <h1 className="text-xl font-bold text-zinc-900">Company Settings</h1>
                            ...
                            <form onSubmit={e => handleSave(e, def.type)} className="p-6 space-y-4">
                                ...
                                <div className="flex flex-col items-end gap-2 pt-2">
                                    <div className="flex gap-3">
                                        ...
                                        <button
                                            type="submit"
                                            disabled={saving === def.type || !canSave}
                                            title={!canSave ? 'Contact your manager to update integration settings.' : undefined}
                                            className="px-4 py-2 rounded-lg text-xs font-semibold text-white hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
