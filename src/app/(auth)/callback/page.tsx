...
export default function AuthCallbackPage() {
    ...
    useEffect(() => {
        // The Supabase JS client automatically exchanges the hash tokens
        // for a session when getSession() is called.
        supabase.auth.getSession().then(({ data: { session } }) => {
            ...
            // Determine where to send the user based on the auth type in the hash
